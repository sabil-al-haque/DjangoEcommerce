...
def address(request):
	...
	return render(request, 'app/address.html', {'add':add, 'active':'btn-success', 'totalitem':totalitem})
...
class ProfileView(View):
	...
	def post(self, request):
		...
		if form.is_valid():
			...
			zilla = form.cleaned_data['zilla']
			division = form.cleaned_data['division']
			zipcode = form.cleaned_data['zipcode']
			reg = Customer(user=usr, name=name, thana=thana, zilla=zilla, division=division, zipcode=zipcode)
			reg.save()
